                  ...
                  <table class="table"> 
                           ...
                           @foreach($students as $student) 
                              ...
                              <tr>
                                  ...
                                  <td> {{$student->rows->name}} </td>

                                <td>
                              <a href="{{route('studen.delete',$student->id)}}" onclick="return confirm('{{__('slider.sure')}}')" class="btn btn-primary btn-sm ml-2 float-right">{{__('student.Delete')}}</a>
